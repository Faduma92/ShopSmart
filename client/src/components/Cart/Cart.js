    ...
    <div>
      ...
      {cartStorage.length > 0 && (
            ...
            <Card.Title>Product Name</Card.Title>
                    ...
                    <Col xs lg="1">
        <Card.Title>The Cost</Card.Title>
                    </Col>
                    <Col xs lg="1">
        <Card.Title>Cost Tax</Card.Title>
                    </Col>
                    <Col xs lg="1">
                    </Col>
                  </Row>
        ...
        <Card border="secondary">
          <Card.Body>
            <Row >
              ...
              <Col xs lg="1">
            <Card.Title>$ {(Math.round((value.price) * 1.13 * 100) / 100).toFixed(2)}</Card.Title>
              </Col>
              <Col xs lg="1">
                <Button variant="primary" onClick={() => removeData(value.skunumber)}>Remove</Button>
              </Col>
            </Row>
          </Card.Body>
        </Card>
      ...
      {cartStorage.length > 0 && (
            ...
            <Card.Title>Grand Total</Card.Title>
                    ...
                    <Col xs lg="1">
        <Card.Title>$ {(Math.round(getTotalSum(cartStorage) * 100) / 100).toFixed(2)}</Card.Title>
                    </Col>
                    <Col xs lg="1">
        <Card.Title>$ {(Math.round(getGrandTotalSum(cartStorage) * 1.13 * 100) / 100).toFixed(2)}</Card.Title>
                    </Col>
                    <Col xs lg="1">
                <Button variant="danger" onClick={() => clearData()}>Clear Cart</Button>
                    </Col>
                  </Row>
                </Card.Body>
              </Card>
