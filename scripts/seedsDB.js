...
const productSeed = [
  {
    ...
    price: 19.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/prairie-naturals.png`),
    stockquantity: 200,
  ...
  },
  {
    ...
    price: 7.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/omega-alpha.png`),
    stockquantity: 450,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 17.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/dutchman-honey.png`),
    stockquantity: 300,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 39.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/vega-sports-protein.png`),
    stockquantity: 100,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 5.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/granola-bar.png`),
    stockquantity: 200,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 8.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/jamieson-vitamin-b2.png`),
    stockquantity: 500,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 1.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/tea-tree-soap.png`),
    stockquantity: 1000,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 1.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/aloe-soap.png`),
    stockquantity: 1000,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 9.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/naturals-shampoo.png`),
    stockquantity: 200,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 20.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/derma-sunscreen.png`),
    stockquantity: 200,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 8.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/naturals-handcream.png`),
    stockquantity: 100,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 11.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/aloe-jelly.png`),
    stockquantity: 100,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 699.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/lenovo-laptop.png`),
    stockquantity: 50,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 299.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/sony-headphones.png`),
    stockquantity: 100,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 999.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/sony-digital-camera.png`),
    stockquantity: 30,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 99.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/bose-waterproof-speaker.png`),
    stockquantity: 100,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 34.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/lenovo-digital-clock.png`),
    stockquantity: 100,
    productCreated: { type: Date, default: Date.now },
  },
  {
    ...
    price: 69.99,
    productimage: readImageData(`${__dirname}/../public/assets/img/products/digital-air-fryer.png`),
    stockquantity: 50,
    productCreated: { type: Date, default: Date.now },
  },
